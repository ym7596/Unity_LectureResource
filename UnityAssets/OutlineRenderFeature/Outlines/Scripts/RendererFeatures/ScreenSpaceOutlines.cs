...
public class ScreenSpaceOutlines : ScriptableRendererFeature {
    ...
    private class ScreenSpaceOutlinePass : ScriptableRenderPass {
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData) {
            ...
            //추가
            // Depth Buffer
            textureDescriptor.colorFormat = RenderTextureFormat.Depth;
            textureDescriptor.depthBufferBits = 24;
            RenderingUtils.ReAllocateIfNeeded(ref depthBuffer, textureDescriptor, FilterMode.Point);
            
           ConfigureTarget(normals,depthBuffer);
           ConfigureClear(ClearFlag.Color | ClearFlag.Depth, settings.backgroundColor);
        }
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
            ...
            cmd.SetGlobalTexture(Shader.PropertyToID("_CameraDepthTexture"), depthBuffer.rt);
